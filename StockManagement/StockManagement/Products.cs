...
namespace StockManagement
{
    public partial class Products : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(connectionString: @"Data Source=.\sqlexpress;Initial Catalog=Stock;Integrated Security=True");
            //Insert logic
            con.Open();
            bool status = false;
            ...
            {
                sqlQuery = @"[Products],[ProductName] = '" + textBox2.Text + "', [ProductStatus] = '" + status + "', WHERE[ProductCode] = '" + textBox1.Text +"'";
            }
            else
            {
        ...
        private void dataGridView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows[0].Cells[2].Value.ToString()=="Activate")
            {
                comboBox1.SelectedIndex = 0;
            }
            else
